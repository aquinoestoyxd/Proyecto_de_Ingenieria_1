...
### US20130096752A1: System and Method for Monitoring and Controlling Indoor Environment Quality and Managing Energy Consumption

Este proyecto describe un sistema y método para monitorear y controlar la Calidad Ambiental Interior (IEQ) en edificios. Utiliza diversos sensores para medir parámetros (incluyendo CO2, temperatura y humedad) y una interfaz de usuario que proporciona al ocupante información sobre las condiciones de la sala. El sistema es capaz de generar recomendaciones específicas (ajustar la ventilación o iluminación) o controlar automáticamente los sistemas del edificio para gestionar el consumo energético [4].

<p align="center">
  <img src="https://github.com/aquinoestoyxd/Proyecto_de_Ingenieria_1/blob/main/Im%C3%A1genes/Patente%203.png?raw=true"/>
</p>

### WO2016147171A1: System and method for air quality monitoring and proactive control in smart buildings

La invención se refiere a un sistema de monitoreo de la calidad del aire que utiliza algoritmos para predecir condiciones ambientales deficientes antes de que ocurran. El sistema está diseñado para el control proactivo, lo que implica que puede ejecutar acciones de control o notificaciones (alertas) de manera anticipada. Su objetivo es mantener las condiciones ambientales dentro de los rangos óptimos en un contexto de edificio inteligente, minimizando el impacto en la ocupación y el bienestar [5]

<p align="center">
  <img src="https://github.com/aquinoestoyxd/Proyecto_de_Ingenieria_1/blob/main/Im%C3%A1genes/Patente%203.png?raw=true"/>
</p>

### EP3875883A1: Systems and methods for classifying, characterizing, and providing information about environments

Este documento presenta sistemas y métodos para clasificar y caracterizar ambientes interiores. El sistema evalúa un espacio completo basándose en la recopilación de múltiples datos ambientales (temperatura, ruido, calidad del aire, etc.). La invención utiliza los datos para clasificar la idoneidad o el nivel de confort del entorno, permitiendo a los administradores y usuarios tomar decisiones informadas sobre la adecuación del espacio para una actividad específica [6]
